...
public:
    ...
    **/
    static string ToNewickString(Node* root, bool addBranchLengthToLabel = false);


private:
    static int ReadNodeChildren(string &str, int revstartpos, Node* curNode);

    static void WriteNodeChildren(string &str, Node* curNode, bool addBranchLengthToLabel);
