...
//Checking if 2 binary nodes/trees are equals
bool Node::Equals(Node* tree2)
{
    Node* tree1 = this;
    ...
    //if (tree1->GetBranchLength() == tree2->GetBranchLength())
      //return false;
    else if (tree1->GetNbChildren() == 2 and tree2->GetNbChildren() == 2){
      return ((tree1->children[0]->Equals(tree2->children[0]) and tree1->children[1]->Equals(tree2->children[1])) or (tree1->children[0]->Equals(tree2->children[1]) and tree1->children[1]->Equals(tree2->children[0])));
    }
    return false;
}
