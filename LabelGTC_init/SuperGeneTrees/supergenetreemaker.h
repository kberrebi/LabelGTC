...
public:
    ...
    pair<Node*, int> GetSuperGeneTreeMinDL(vector<Node *> &trees, vector<Node *> &clades_to_preserve, vector<Node *> &treated_trees, vector<unordered_map<Node *, Node *> > &lca_mappings,
